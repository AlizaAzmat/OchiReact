...
function Footer() {
  return (
    <div className='w-full h-screen flex gap-5 bg-zinc-900 p-20'>
        <div className='w-1/2 flex flex-col h-full justify-between font-["Founders Grotesk X-Condensed"]'>
            <div className='headings'>
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-2'>Eye-</h1>
            <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-2'>Opening</h1>
            </div>
        ...
        <div className='w-1/2 font-["Founders Grotesk X-Condensed"]'>
           <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-2'>Presentations
           </h1>
